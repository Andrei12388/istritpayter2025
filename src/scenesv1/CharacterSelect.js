...
export class CharacterSelect {
    ...
    characters = [
        ...
        { name: "Baby Giant", color: "gray",  imageSml: 'babygiantSmall', imageBig: 'babygiantBig'},
        { name: "Unknown1", color: "gray", imageSml: 'unknownSmall', imageBig: 'unknownBig' },
    ...
    handleInput(playerId) {
        ...
        if (control.isControlPressed(playerId, Control.LEFT)&& this.selectEnable[playerId] === true && controlHold.tapped === true) {
        ...
        if (control.isControlPressed(playerId, Control.RIGHT)&& this.selectEnable[playerId] === true && controlHold.tapped === true) {
        ...
        // Confirm selection
        if (control.isControlPressed(playerId, Control.LIGHT_PUNCH) && this.selectEnable[playerId]) {
            ...
            if (
                this.selectedCharacters[otherPlayer] &&
                this.selectedCharacters[otherPlayer].name === selectedChar.name
            ) {
                console.log(`Player ${playerId + 1} tried to pick ${selectedChar.name}, but it's already taken.`);
                return;
            }
    ...
    selectCharacter(playerId, character) {
        ...
        if (this.selectedCharacters[0] && this.selectedCharacters[1]) {
            console.log("Both players selected. Transitioning to battle.");
